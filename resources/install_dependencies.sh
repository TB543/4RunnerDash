...
rm test_data.zip
cp dark_map_style.json ../src/Lib/tileserver/styles/maptiler-basic/style_dark.json
sed -i 's#"mbtiles": "zurich_switzerland.mbtiles"#"mbtiles": "map_data/map.mbtiles"#' ../src/Lib/tileserver/config.json
sed -i 's#"styles": {#"styles": {"maptiler-basic-dark":{"style":"maptiler-basic/style_dark.json"},#' ../src/Lib/tileserver/config.json
